        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pilih Menu</h6>
             <a  <?php if ($_GET['module'] == 'problem' || $_GET['module'] == '') {?><?php } ?> href ="?module=problemsolving" class ="collapse-item"> Problem Solving </i></a>
             <a  <?php if ($_GET['module'] == 'gejala' || $_GET['module'] == '') {?><?php } ?> href = "?module=gejala" class ="collapse-item"> Gejala </i></a>
             <a  <?php if ($_GET['module'] == 'problem' || $_GET['module'] == '') {?><?php } ?> href = "?module=problem" class ="collapse-item"> Kasus </i></a>
          </div>
        </div>
      </li>
