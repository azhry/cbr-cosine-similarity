...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="?module=kelola_user">
          <i class="fas fa-fw fa-user-alt"></i>
          <span>Kelola User</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="?module=kelola_jabatan">
          <i class="fas fa-fw fa-user-alt"></i>
      ...
      <li class="nav-item">
        ...
        <div id="collapsec" class="collapse" aria-labelledby="headingc" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" <?php if ($_GET['module'] == 'lihat_reward' || $_GET['module'] == '') {?> class="active" <?php } ?> href="?module=lihat_reward">List Reward</a>
            <a class="collapse-item" <?php if ($_GET['module'] == 'atur_item_reward' || $_GET['module'] == '') {?> class="active" <?php } ?> href="?module=atur_item_reward">Pengaturan Reward</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <?php
            $sql = "SELECT * FROM reward join item_reward on reward.id_item=item_reward.id_item join user on reward.user_id=user.user_id where reward.status='Belum Diambil' order by reward.id_reward desc";
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                ?>
                <a class="dropdown-item d-flex align-items-center" href="?module=alert_reward&id_reward=<?php echo $data['id_reward']; ?>">
                  <div class="mr-3">
                  ...
                  <div>
                    <div class="small text-gray-500"><?php echo time_since(strtotime($data['tgl_ambil'])); ?></div>
                    <span class="font-weight-bold">Reward Atas Nama <?php echo $data['nama']; ?> Dengan NIP : <?php echo $data['nip']; ?> Akan Mengambil Reward...</span>
                  </div>
                </a>
